...
def index123():
    ...
    cur2.execute("SELECT * FROM products WHERE category=%s ORDER BY RAND() LIMIT 4", (values,))
    tshirt2 = cur2.fetchall()
    cur2.close()
    #mau don thu 3
    cur3 = mysql.connection.cursor()
    cur3.execute("SELECT * FROM products WHERE category=%s ORDER BY RAND() LIMIT 8", (values,))
    tshirt3 = cur3.fetchall()
    cur3.close()
    #mau don thu 4
    cur4 = mysql.connection.cursor()
    cur4.execute("SELECT * FROM products WHERE category=%s ORDER BY RAND() LIMIT 8", (values,))
    tshirt4 = cur4.fetchall()
    cur4.close()

    return render_template('1index.html',tshirt=tshirt ,tshirt2=tshirt2, tshirt3=tshirt3, tshirt4=tshirt4)
